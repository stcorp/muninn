...
- Check the list of dependencies in the README
- Check version numbers mentioned elsewhere in the README
- Check the upgrade instructions in README
- Add change history entry in CHANGES
- Check that the content of EXTENSIONS is up to date (any API changes?).
- Check version numbers mentioned in EXTENSIONS.
